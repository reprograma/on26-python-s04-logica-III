...
tabuada_de = int(input("Digite um numero inteiro: "))
numero_inicial = int(input("Inicio da tabuada: "))
numero_final = int(input("Fim da tabuada: "))
...
while numero_inicial <= numero_final:
    resultado = numero_inicial * tabuada_de
    print(resultado)
    numero_inicial += 1
